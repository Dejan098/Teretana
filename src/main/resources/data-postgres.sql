...
insert into "schedule"(id,price,beginDate,training_id) values (nextval('seq_schedule'),100,'2021-01-01',1);
insert into "schedule"(id,price,beginDate,training_id) values (nextval('seq_schedule'),160,'2021-02-01',2);
