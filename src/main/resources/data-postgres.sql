insert into "users"(rolee,id,password,namee,korisnickoime,surname,phoneNumber,email,birthDate,rola,active,enabled) values ('member',nextval('seq_user'),'$2y$10$1p9FJ4b6sWPs97ACLIeG8.5VRhK4.4roqBGVI6PQjmnOyKM2jCwou','Dejan','deks','Dvornic','1234','dvornicdejan08@gmail.com','1998-02-08','trainer',true,true);
